...
ceiling_frame = Frame([[0.,0., total_height], [1., 0., 0.], [0., 1., 0.], [0., 0., 1.]])
...
create_door(3,4, close = False)


create_window(1,2, close = True)
create_window(0,3, close = True)
...
union = general_fuse_algorithm([walls_with_holes]+[union_closings])
#show_shapes([[ceiling,'BLUE']]+[[floor,'BLUE']]+[[bbox,'RED']]+[[union, 'CYAN']])
neg = general_fuse_algorithm([union,floor,ceiling, union_heats])
volume = general_split_algorithm([bbox],[neg])
